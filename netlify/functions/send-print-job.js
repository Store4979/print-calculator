...
exports.handler = async (event) => {
  ...
  const { subject, to, jobType, details, pdfBase64, orderSheetPdfBase64 } = body;
...
`;
    ...
    if (orderSheetPdfBase64) {
      const cleaned2 = String(orderSheetPdfBase64).replace(/^data:application\/pdf;base64,/, "");
      mailOptions.attachments.push({
        filename: "print-order-sheet.pdf",
        content: Buffer.from(cleaned2, "base64"),
        contentType: "application/pdf",
      });
    }
